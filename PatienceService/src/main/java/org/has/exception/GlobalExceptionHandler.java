...
import static org.has.exception.ErrorType.BAD_REQUEST_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(PatienceException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleMonolitSpotifyException(PatienceException exception){
